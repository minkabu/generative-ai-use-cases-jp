...
const usePdfChatState = create<{
  ...
  const formatMessageProperties = (
    ...
    return messages.map((m) => {
      return {
        role: m.role,
        content: m.content + '<pdf>' + pdfText + '</pdf>',
        extraData: undefined,
      };
    });
  };
  ...
  return {
    ...
    getCurrentSystemContext: (id: string) => {
      ...
      console.log('uusePdfChat: id:' + id + ', chat:' + chat);
    ...
    post: async (
      ...
      pdfText: string | undefined = undefined
    ) => {
 ...
 * @returns
 */
const usePdfChat = (id: string, chatId?: string) => {
  const {
    chats,
    isLoading,
    getModelId,
  ...
  return {
    ...
    postChat: (
      ...
      postProcessOutput: ((message: string) => string) | undefined = undefined,
      sessionId: string | undefined = undefined,
      extraData: string | undefined = undefined
    ) => {
      post(
        id,
        content,
